...
object AvgTemperature3 {
  ...
  def main(args: Array[String]) {
    ...
    val resultRDD = dayTemp.combineByKey((value: Int) => (value, 1),
    ...
    println(s"Number of Records in the result: ${resultRDD.count()}")
    resultRDD.saveAsTextFile("hdfs://localhost/user/cloudera/spark101/avg_temperature/output")
